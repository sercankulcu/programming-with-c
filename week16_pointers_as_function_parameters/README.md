...
📖 **[Lecture notes](https://sercankulcu.github.io/files/c/Week_16_Pointers_as_Parameters.html)** — read these first; the code here is the worked example from that page.
